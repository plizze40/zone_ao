...
Private Sub Form_Load()
    ...
    frmComerciar.Picture = PictureLoader.LoadStdPicture("comerciar.png")
    frmComerciar.Image2(0).Picture = PictureLoader.LoadStdPicture("Cantidad.png")
    frmComerciar.Image2(1).Picture = PictureLoader.LoadStdPicture("Precio.png")
...
Private Sub Image1_Click(Index As Integer)
    ...
    Case 0
        ...
        Case 1
            ...
            Else
                AddtoRichTextBox frmPrincipal.rectxt, "No tenés suficiente oro.", 2, 51, 223, 1, 1
                Exit Sub
            End If
        Case 2
