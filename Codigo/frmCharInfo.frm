...
Private Sub Form_Load()
    ...
    Me.Picture = PictureLoader.LoadStdPicture("CharInfo.png")
    Echar.Picture = PictureLoader.LoadStdPicture("echar.png")
    desc.Picture = PictureLoader.LoadStdPicture("desc.png")
    Aceptar.Picture = PictureLoader.LoadStdPicture("aceptar.png")
    Rechazar.Picture = PictureLoader.LoadStdPicture("rechazar.png")
