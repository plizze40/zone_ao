...
Begin VB.Form frmSubeClase2 
   ...
   Begin VB.Label Label3 
      Alignment       =   2  'Center
      BackStyle       =   0  'Transparent
      Caption         =   $"Frmrecompensa2.frx":091E
      ForeColor       =   &H00FFFFFF&
      Height          =   975
      Left            =   480
      TabIndex        =   2
...
Private Sub Form_Load()
    ...
    Me.Picture = PictureLoader.LoadStdPicture("Suclases2op.png")

    Select Case MiClase
    Case CIUDADANO

        frmSubeClase2.Command1(0).Enabled = False
        frmSubeClase2.Label1.Enabled = False
        frmSubeClase2.Label4.Enabled = False
