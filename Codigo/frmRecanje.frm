...
Begin VB.Form frmRecanje 
   ...
   Begin VB.CommandButton Command23 
      Caption         =   "Sombrero de la Alianza"
      Height          =   495
      Left            =   3960
      TabIndex        =   23
      Top             =   3360
   ...
   Begin VB.CommandButton Command22 
      Caption         =   "Sombrero de las Sombras"
      Height          =   495
      Left            =   3960
      TabIndex        =   22
      Top             =   2760
...
Private Sub Command25_Click()
    Call SendData("/RECANJEO T25")
End Sub

Private Sub Command26_Click()
    Call SendData("/RECANJEO T26")
End Sub

Private Sub Command27_Click()
    Call SendData("/RECANJEO T27")
End Sub

Private Sub Command28_Click()
    Call SendData("/RECANJEO T28")
End Sub

Private Sub Command29_Click()
    Call SendData("/RECANJEO T29")
End Sub
