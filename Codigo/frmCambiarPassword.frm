...
Private Sub Aceptar_Click()
    ...
    If Len(Me.PasswdNuevo) < 6 Then
        Call AddtoRichTextBox(frmPrincipal.rectxt, "El password nuevo debe tener al menos 6 caracteres.", 65, 190, 156, False, False, False)
        Exit Sub
    End If
...
Private Sub Form_Load()
    ...
    Me.Picture = PictureLoader.LoadStdPicture("password.png")
