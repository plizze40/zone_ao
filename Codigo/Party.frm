...
Private Sub Form_Load()
    ...
    Me.Picture = PictureLoader.LoadStdPicture("sistemaparty.png")
    Invitar.Picture = PictureLoader.LoadStdPicture("invitar.png")
    Echar.Picture = PictureLoader.LoadStdPicture("echarparty.png")
    Salir.Picture = PictureLoader.LoadStdPicture("salirparty.png")
