...
Sub HandleData(ByVal Rdata As String)
    ...
    Case "LOGGED"
        Call SetMusicInfoO("Jugando ZoneAO, Nick: " & UserName & ", Nivel: " & UserLvl & ",Oro: " & UserGLD & " ", " ", "ZoneAO.ucoz.com")
        Sincroniza = Timer
        logged = True
        UserCiego = False
        EngineRun = True
    ...
    Case "FINOK"
        ...
        If Musica = 0 Then
            ...
            Play_Midi
        End If
        'Call frmPrincipal.StopSound 'FIXME
    ...
    Case "INITCOM"
        ...
        frmComerciar.Image1(0).Picture = PictureLoader.LoadStdPicture("Comprar.png")
        frmComerciar.Image1(1).Picture = PictureLoader.LoadStdPicture("Vender.png")
        Comerciando = 1
        frmComerciar.Show
        Exit Sub
    ...
    Case "INITBANCO"
        ...
        frmComerciar.Image2(1).Visible = False
        frmComerciar.precio.Visible = False
        frmComerciar.Image1(0).Picture = PictureLoader.LoadStdPicture("Retirar.png")
        frmComerciar.Image1(1).Picture = PictureLoader.LoadStdPicture("Depositar.png")
    ...
    Case "INITIENDA"
        ...
        frmComerciar.Image1(0).Picture = PictureLoader.LoadStdPicture("Quitar.png")
        frmComerciar.Image1(1).Picture = PictureLoader.LoadStdPicture("Agregar.png")
        Comerciando = 3
        frmComerciar.Show
        ...
        Else
            If bLluvia(UserMap) <> 0 Then
                If bTecho Then
                    ...
                    'Call frmPrincipal.StopSound 'FIXME
                    'Call frmPrincipal.Play("lluviainend.wav", False) 'FIXME
                    'frmPrincipal.IsPlaying = plNone 'FIXME
    ...
    Case "EST"
        ...
        frmPrincipal.STAShp.width = (((UserMinSTA / 9999) / (UserMaxSTA / 9999)) * 94)
    ...
    Case "EIFYA"
        ...
        If frmPrincipal.Fuerza = 0 Then
            frmPrincipal.Image8.Visible = False
            frmPrincipal.Fuerza.Visible = False
        Else
            frmPrincipal.Image8.Visible = True
            frmPrincipal.Fuerza.Visible = True
            frmPrincipal.Fuerza.ForeColor = vbYellow
        End If
        frmPrincipal.Agilidad = ReadField(2, Rdata, 44)
        If frmPrincipal.Agilidad = 0 Then
            frmPrincipal.Image9.Visible = False
            frmPrincipal.Agilidad.Visible = False
        Else
            frmPrincipal.Image9.Visible = True
            frmPrincipal.Agilidad.Visible = True
            frmPrincipal.Agilidad.ForeColor = vbYellow
        End If
        Exit Sub
    Case "DADOS"
        Rdata = right$(Rdata, Len(Rdata) - 5)
...
Sub HandleDosLetras(ByVal Rdata As String)
    ...
    Case "TX"
        ...
        Call SetCharacterFx(CharIndex, Val(ReadField(3, Rdata, 44)), Val(ReadField(4, Rdata, 44)))
        Exit Sub
    Case "GL"
        Rdata = right$(Rdata, Len(Rdata) - 2)
    ...
    Case "FO"
        ...
        'If frmPrincipal.IsPlaying <> plFogata Then 'FIXME
        'frmPrincipal.StopSound
...
Public Function GetPortAddress() As Long
    GetPortAddress = 7676
End Function
